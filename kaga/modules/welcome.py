...
*Khusus Admin:*
 ...
 × /setgoodbye <sometext>: Setel pesan selamat tinggal kustom. Jika digunakan membalas media, gunakan media itu.
...
Ini membuktikan bahwa mereka bukan bot! lunak - membatasi kemampuan pengguna untuk mengirim media selama 24 jam. kuat - bisu saat bergabung sampai mereka membuktikan bahwa mereka bukan bot.
...
Anda dapat membuat tombol menggunakan `[button text](buttonurl://example.com)`.
...
Ujung tautan `: same` menggabungkan 2 tombol pada baris yang sama dengan 1 tombol, sehingga tombol ke-3 akan dipisahkan \
