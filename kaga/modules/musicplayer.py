...
- /skip : Lewati lagu saat ini (khusus Admin)
- /end : Akhiri pemutaran musik (khusus Admin)
*HARAP DIPERHATIKAN, INI SANGAT TIDAK STABIL DAN DAPAT DIHENTIKAN KAPAN SAJA*
"""
